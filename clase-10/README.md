...
Los archivos contenidos en [esta carpeta de repositorio](https://profesorfaco.github.io/dno037-2023-2/clase-10/index.html) servirán de base para un "remake" de la evaluación N°2. 

Conviene tener a mano la [documentación de Bootstrap](https://getbootstrap.com/docs/5.3/getting-started/introduction/).
...
Lo que sea publicado en GitHub Pages e ingresado al foro de la clase, será evaluado como:
...
Por tratarse de un ejercicio: El foro se cierra a las 23.59 hrs.
