### Diseño y Nuevos Medios → Clase 03 → 23/08/2023
...
En la [clase recién pasada](https://github.com/profesorfaco/dno037-2023-1/tree/main/clase-02) aprovechamos [`loadJSON()`](https://p5js.org/es/reference/#/p5/loadJSON), para obtener [datos de un JSON](https://raw.githubusercontent.com/profesorfaco/dno037-2023-1/main/clase-02/regiones.json) que tenía la siguiente estructura:
...
Paso 9 → El JSON en línea → https://raw.githubusercontent.com/profesorfaco/dno037-2023-1/main/clase-03/ejemplo.json
...
En el mismo [Web Editor de p5.js](https://editor.p5js.org/), podemos hacer una prueba con el JSON de las regiones del país usado en el ejemplo de la [clase recién pasada](https://github.com/profesorfaco/dno037-2023-1/tree/main/clase-02) y mencionado más arriba → https://raw.githubusercontent.com/profesorfaco/dno037-2023-1/main/clase-02/regiones.json
...
function preload() {
  datos = loadJSON(
    "https://raw.githubusercontent.com/profesorfaco/dno037-2023-1/main/clase-02/regiones.json"
  );
}
function setup() {
  noCanvas();
